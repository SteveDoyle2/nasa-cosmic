      SUBROUTINE ORDER8(VALUES,NUM,IORD)
...
C --------  ---  ----  ---  -----------
C
C VALUES    NUM  R*8    I   THE VALUES FOR WHICH THE ORDER IS TO BE
C                           DETERMINED.
C
...
C  C PETRUZZO. 8/82.
C
C  MODIFIED......12/83. CJP. CHANGED RESTRICTION ON THE MAX NUMBER OF
C                       VALUES THAT CAN BE ENTERED. THIS INVOLVED AN
C                       ALMOST COMPLTE REPLACEMENT OF THE CODE.
C
C*********************************************************************
C
      DIMENSION VALUES(1)
...
C
      DO 200 II=1,NUM
      TESTMIN = R8BIG      ! R8BIG = APPROX LARGEST REAL*8 VALUE
C
      DO 300 JJ=1,NUM
