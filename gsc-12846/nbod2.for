...
C     IDEM4 = SIZE OF /LOGIC/       16 LOGICAL WORDS                     82
C     IDEM5 = SIZE OF /INTG/       724 INTEGER WORDS                     83
C     IDEM6 = SIZE OF /INTGZ/       70 INTEGER WORDS                     84
C     IDEM7 = SIZE OF /REAL/      7324 REAL WORDS                        85
C     IDEM8 = SIZE OF /REALZ/      168 REAL WORDS                        86
...
C
      ...
      DIMENSION QFK(3,3)
      INTEGER S1(10),S2(10),S3(10),SML,S4( 63)                           39
      LOGICAL CTAIN
C
C
...
C
     ...
     *                LQFDOT , LDCT   , LANGLE , LSETUP , LSIMQ
      ...
      DIMENSION XMCDUM(1,1, 9),XMC(3,3,1)                                40
...
C
      ...
      INTEGER ST1(10),ST2(10),ST3(10),ST4(10),SFXMN                      42
...
C
      ...
      DIMENSION TEM(3)
      DIMENSION TEM1(3,3)
      INTEGER ST1(10),SET(24),SFXMN                                      45
...
C
     ...
     *            (SCNDUM,IZINIT(1))
      DIMENSION X1(3),X2(3)
      DIMENSION TEM1( 33),TEM2( 33)                                      46
      REAL*8 EFOMC( 33),ECOMC( 33),EROMC( 33),EDOMC( 33)                 47
      INTEGER SET(24)                                                    48
      LOGICAL CTAIN
C
...
C
     ...
     *            (SCNDUM,IZINIT(1))
C
      INTEGER ST1(10),ST2(10),ST3(10),ST4(10)                            49
...
C
     ...
     *            (SCNDUM,IZINIT(1))
C
      INTEGER ST1(10),ST2(10),ST3(10),ST4(10),SET(24),SFXMN              50
...
C
C
      DIMENSION TEM1(3),TEM(3,11),XQD(3,11)                              52
      DIMENSION TEM2(3),TEM3(3),FTEM(3),FLHC(3,3)
      DIMENSION EQFC( 99), EXDIC( 594)                                   53
      REAL*8    FCUP(3,3,20),FCUP1(3,3),KCUP(3,20),KCUP1(3)              54
      REAL*8    TMF(3,3), TMK(3)
      INTEGER ST1(10),ST2(10),ST3(11)                                    55
      INTEGER ST4(10)                                                    56
      INTEGER SFXMN
      LOGICAL CTAIN
...
C
C
      COMMON /INTG/ AWORK(184),ST1,N,M,MM,NST1,J,I,                      59
     * CT1           , CT2           , CT3           , CT4           ,
     * CT5           , FCON  (33)    , JCON  (10)    , LCON  (22)    ,    7
     * MO    (10)    , NB1           , NBOD          , NCTC          ,    8
     * NFER          , NFKC          , NFRC          , NLOR          ,
