	PROGRAM RLASER
C *** LAST REVISED ON 12-AUG-1987 10:53:40.41
C *** SOURCE FILE: [DL.GRAPHICS.LONGLIB]RLASER.FOR
C
C	CREATED:  DGL JULY 1987
C
C	THIS PROGRAM CONVERTS THE LONGLIB PRINTER HISTORY META FILE
C	INTO QUIC TEXT FILE FOR A QMS LASER PRINTER.  THIS VERSION
C	ROTATES AND SCALES INPUT IMAGE.
C
