	PROGRAM TRILGLO
C *** LAST REVISED ON  5-OCT-1987 07:26:21.81
C *** SOURCE FILE: [DL.GRAPHICS.LONGLIB]TRILGLO.FOR
C
C	CREATED:  DGL JULY 1987
C
C	THIS PROGRAM CONVERTS THE LONGLIB PRINTER HISTORY META FILE
C	INTO A DOT MATRIX PRINT FILE FOR A TRILOG PRINTER.
C
...
C
C	(NONE NEEDED FOR TRILOG LO-RES)
C
	RETURN
	END
C
...
500	CONTINUE
	...
	BLONGP=(NBAND-1)*NMAP
C
C	DEFAULT SOLID LINE WITH UNIT DOT WIDTH
C
	LWIDE=1
	LTYPE=0
	DO 5 I=1,16
